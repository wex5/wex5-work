...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:407px;left:83px;height:auto;"
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="true"
      xid="checkInOutDataDOut" queryAction="queryOa_chekinout" saveAction="saveOa_chekinout"
      url="/work/attendance" tableName="oa_chekinout" idColumn="fID" confirmRefresh="false">
      ...
      <rule xid="rule1"> 
        <col name="fID" xid="ruleCol1"> 
          <calculate xid="calculate1"> 
            <expr xid="default1">justep.UUID.createUUID()</expr>
          </calculate> 
        </col> 
      </rule>
    </div>
