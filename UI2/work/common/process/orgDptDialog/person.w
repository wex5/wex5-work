...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="x-flex x-flex-column"
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;">
   <div class="x-col x-col-fixed x-col-center" xid="col1" style="width:auto;" bind-visible="val(&quot;sOrgKindID&quot;)  == 'psm'">
    <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox" xid="check" name="org" onChange="checkChange"></span></div> 
   <div class="x-col x-col-fixed x-col-center" xid="col3" style="width:auto;" bind-visible=" val(&quot;sOrgKindID&quot;) =='psm'">
    <div xid="div6" class="photoDiv" style="display:inline-block;">
   <span xid="span6" bind-text=' val("sName").slice(-2)' style="font-weight:bold;color:#FFFFFF;font-size:medium;"></span></div></div> 
   <div class="x-col x-col-center" xid="col2">
    <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelOutput1" style="display:inline-block;"> 
                  <!-- <label class="x-label" xid="label1" bind-text="ref('sName')"/> -->  
                  <div class="x-edit x-tree-link" xid="div1"> 
                    <div component="$UI/system/components/justep/output/output" class="x-output" xid="output1" bind-ref="ref('sName')" /> 
                  </div> 
                </div></div> 
   <div class="x-col x-col-fixed" xid="col4" style="width:auto;" bind-visible=" val(&quot;sOrgKindID&quot;) !='psm'">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-right pull-right" xid="button2" bind-visible="$model.getCount($object)!=0">
   <i xid="i4"></i>
   <span xid="span5" bind-text='"(" + $model.getCount($object) + ")";'></span></a></div> </div></li> 
            </ul>  
