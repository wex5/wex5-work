...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1">
    <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" style="background-color:#4B73A4;">
     <div xid="left1" style="line-height:46px;">
     ...
     <div xid="right1" style="text-align:left;" class="x-titlebar-right">
      <span xid="span2">组织机构管理</span></div> </div> </div> 
   <div class="x-panel-content" xid="content1">
    <div component="$UI/system/components/justep/org/orgTree" class="x-tree x-inner-scroll" limit="10" rootLabel="组织机构" xid="orgTree1">
     ...
     <div class="x-tree-content x-scroll-view" xid="div2">
      <div component="$UI/system/components/justep/scrollView/scrollView" supportPullDown="true" supportPullUp="true" hScroll="false" vScroll="true" hScrollbar="false" vScrollbar="true" bounce="true" class="x-scroll" xid="scrollView1">
       ...
       <div class="x-content-center x-pull-up" xid="div4">
        <span class="x-pull-up-label" xid="span4">加载更多...</span></div> </div> </div> </div> </div> </div>
   ...
   <div class="modal-dialog" xid="div11" style="width:90%;height:80%;margin:10% 5%;">
    <div class="modal-content" xid="div12" style="width:100%;height:100%;">
     <div class="modal-header" xid="div13">
      <h4 class="modal-title" xid="h41">您可以将该人员移动到以下机构：</h4></div> 
     <div class="modal-body" xid="div14" style="height:90%;">
      <div component="$UI/system/components/justep/org/orgTree" class="x-tree x-inner-scroll" limit="10" rootLabel="请选择机构" xid="orgTree3" filter=' $row.val("sOrgKindID") !="psm"'>
       ...
       <div class="x-tree-content x-scroll-view" xid="div25">
        <div component="$UI/system/components/justep/scrollView/scrollView" supportPullDown="true" supportPullUp="true" hScroll="false" vScroll="true" hScrollbar="false" vScrollbar="true" bounce="true" class="x-scroll" xid="scrollView4">
         ...
         <div class="x-content-center x-pull-up" xid="div27">
          <span class="x-pull-up-label" xid="span13">加载更多...</span></div> </div> </div> </div> </div> </div> </div> </div></div>