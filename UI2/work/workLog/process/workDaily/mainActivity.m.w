...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;top:83px;height:244px;" onLoad="modelLoad">
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false" xid="mainData" queryAction="queryOa_workdaily" saveAction="saveOa_workdaily" url="/work/workLog" idColumn="fID" autoNew="true" tableName="oa_workdaily"><column label="fID" name="fID" type="String" xid="default19"></column>
  <column label="版本" name="version" type="Integer" xid="default20"></column>
  <column label="填报人" name="fPersonID" type="String" xid="default21"></column>
  <column label="填报人名称" name="fPersonName" type="String" xid="default22"></column>
  <column label="填报部门" name="fDeptID" type="String" xid="default23"></column>
  <column label="填报部门名称" name="fDeptName" type="String" xid="default24"></column>
  <column label="创建日期" name="fCreateTime" type="DateTime" xid="default25"></column>
  <column label="填报日期" name="fDate" type="Date" xid="default26"></column>
  <column label="今日完成工作" name="fFinishWork" type="String" xid="default27"></column>
  <column label="明日工作计划" name="fWorkPlan" type="String" xid="default28"></column>
  <column label="需协调与帮助" name="fNeedHelp" type="String" xid="default29"></column>
  <column label="备注" name="fRemark" type="String" xid="default30"></column>
  <column label="图片路径" name="fImgURL" type="String" xid="default31"></column>
  <column label="发布范围" name="fReleaseScope" type="String" xid="default32"></column>
  <column label="发布范围ID" name="fReleaseScopeID" type="String" xid="default33"></column>
  <rule xid="rule1">
   <col name="fReleaseScope" xid="ruleCol1">
    <required xid="required1">
     <expr xid="default1"></expr>
     <message xid="default2"></message></required> </col> 
   <col name="fID" xid="ruleCol2">
    <calculate xid="calculate1">
     <expr xid="default3">justep.UUID.createUUID()</expr></calculate> </col> </rule></div></div>  
  <div xid="waitDiv" style="position:relative;height:400px;">
   ...
   <span xid="span1"></span></a>
    ...
    <div class="x-panel-content" xid="dailyContent" style="display:none;"> 
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit x-label30"> 
                    <label class="x-label left" bind-text="$model.mainData.label('fNeedHelp')" xid="needHelp" style="width:100px;"></label>  
                    <div class="x-edit"> 
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label left" xid="remarkL" style="width:100px;" bind-text='$model.mainData.label("fRemark")'><![CDATA[]]></label>  
                    <div class="x-edit"> 
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit x-label20"> 
                    <label class="x-label left" xid="imgURL" style="width:100px;"><![CDATA[图片]]></label>  
                    <div class="x-edit"> 
   ...
   <div class="x-attachment" xid="div7">
  ...
  </div> <!-- <span component="$UI/system/components/justep/org/orgDialog" xid="psmDialog" multiSelection="true" onReceive="psmDialogReceive" style="top:18px;left:69px;" includeOrgKind="psm"></span> -->
