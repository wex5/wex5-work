<div 
  ...
  <div xid="mainData" xui:update-mode="delete"/>
    <div autoLoad="true" autoNew="false" component="$UI/system/components/justep/data/baasData" confirmDelete="false" idColumn="sID" limit="20" onBeforeRefresh="mainDataBeforeRefresh" queryAction="querySa_task" saveAction="saveSa_task" tableName="sa_task" url="/work/workTask" xid="mainData" xui:before="statusData" xui:parent="model" xui:update-mode="insert" >
...
<column label="sEBField54" name="sEBField54" type="String" xid="default260" />
   ...
   <div xid="titleBar1" title="查看子任务"  xui:update-mode="merge"/>
   <div xid="title1"  xui:update-mode="merge-and-replace">
查看子任务</div>    <a class="btn btn-link btn-only-icon" component="$UI/system/components/justep/button/button" icon="linear linear-fileadd" label="button" onClick="delBtnClick" xid="delBtn" xui:parent="right1" xui:update-mode="insert" >
<i class="linear linear-fileadd" xid="i3" />
<span xid="span3" />
</a>
   <span xid="messageDialog" onOK="messageDialogOK"  xui:update-mode="merge"/>
